#
#  Add NerTagger's layer to collection.
...
if __name__ == '__main__':
    ...
    #  Initialize tagger
    # =============================================
    tagger = NerTagger( output_layer=config['tagger']["output_layer"], 
                        morph_layer_input=input_morph_analysis_layer, 
                        words_layer_input=input_words_layer, 
                        sentences_layer_input=input_sentences_layer )
