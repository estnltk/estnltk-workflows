#
#  Add StanzaSyntaxTagger's layer to collection.
...
if __name__ == '__main__':
    ...
    # Get extra configuration
    input_type = config[section_name].get('input_type', 'morph_extended')
    input_morph_analysis_layer = config[section_name].get('morph_analysis_layer', 'morph_extended')
    ...
    #  Initialize tagger
    # =============================================
    tagger = StanzaSyntaxTagger( output_layer=config['tagger']["output_layer"], 
