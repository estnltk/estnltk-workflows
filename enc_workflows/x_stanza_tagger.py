#
#   An improved version of StanzaSyntaxTagger which uses 2 instances of 
#   stanza models: GPU/CPU model for parsing texts with normal length sentences, 
#   and a CPU based-model for processing texts with very long sentences (sentence 
