#
#   Aligns textual content and annotations in .vert and .json files
#   (  work  in  progress  )
#
...
if len(sys.argv) > 1:
    ...
    if os.path.isfile(input_fname):
        ...
        if configuration is not None:
            ...
            input_words_layer = 'morph_analysis_ext'
            ...
            for vert_subdir in vert_subdirs:
                ...
                progress_bar = tqdm( desc="Parsing and aligning {}".format(vert_subdir), 
                    ...
                    if vert_document is not None:
                        if int(vert_document[1]['_doc_id']) == json_doc_id:
                            ...
                            for text_obj in found_json_texts:
                                ...
                                for wid, word_token in enumerate(text_obj[input_words_layer]):
                                    ...
                                    if vert_token is not None:
                                        ...
                                        if vert_token_text == word_token.text:
                                            # Words match
                                            processed_words += 1
                                            ...
                                            # Report mismatch
                                            json_context = [sp.text for sp in text_obj[input_words_layer][wid-25:wid+1]]
                                            ...
                                            raise Exception(f'(!) Mismatching vert word {vert_token!r} and '+\
                                                            f' json word {word_token.text!r} at the vert file position '+\
                            ...
                            if not word_tokens:
                                ...
                                # Skip the empty/tokenless vert document
                                subdir_id += 1
